...
`Greetings!` I'm a Data Science Engineer specializing in designing innovative algorithmic and data-driven tools which up-until now has empowered organizations like `Bain & Co.`, `OYO Rooms`, and `Dell Technologies` to better serve their users. Few of my notable self-engineered methods include a cosine-similarity based nearest-neighbor text search engine for quick information retrieval and a binary search based dynamic pricing system that optimizes revenue strategies. Additionally, I have also developed scalable pipelines that harness the capabilities of LLMs to address NLP challenges like sentiment classification and topic modeling, allowing organisations to gain data-based insights and take transformative decisions. 
